"""Keep all existing macro observation times without duplicate cron triggers."""
from collections import Counter
from pathlib import Path
import re


def test_macro_week_has_no_duplicate_and_preserves_every_observation_time():
    ...
    expected = {(day, hour, 35) for day in range(1, 6) for hour in range(0, 24, 2)}
