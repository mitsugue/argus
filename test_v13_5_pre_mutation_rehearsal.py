...
def prepare(tmp_path, monkeypatch):
    ...
    (dist / "index.html").write_text(
        '<script>globalThis.__ARGUS_VERSION__="13.7.36";'
        'globalThis.__ARGUS_PRODUCT_VERSION__="v13.7.36";'
    ...
    write_json(repo / "product-version.json", {
        "schemaVersion": "argus-product-version-v1", "productVersion": "v13.7.36"})
    write_json(repo / "web/package.json", {"version": "13.7.36"})
    write_json(repo / "backend-version.json", {"version": "13.7.36"})
