...
def prepare(tmp_path, monkeypatch):
    ...
    (dist / "index.html").write_text(
        '<script>globalThis.__ARGUS_VERSION__="13.5.42";'
        'globalThis.__ARGUS_PRODUCT_VERSION__="v13.5.42";'
    ...
    write_json(repo / "product-version.json", {
        "schemaVersion": "argus-product-version-v1", "productVersion": "v13.5.42"})
    write_json(repo / "web/package.json", {"version": "13.5.42"})
    write_json(repo / "backend-version.json", {"version": "13.5.42"})
