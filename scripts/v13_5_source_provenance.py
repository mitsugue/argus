...
AUTHORIZED_EXTENSION_PATHS = frozenset({
    # v13.5.24 owner-functional correction: compact iPhone navigation, concise
    ...
    # v13.5.24 SCHEDULED_AI enablement (owner 「有効にして」 2026-08-23/24):
    ...
    # v13.5.24 (external-review conformance batch): SHO CORE production
    ...
    # v13.5.24 owner directive: internal engine names removed from every
    ...
    # v13.5.24 owner spec conformance (2026-08-22): news-risk ⊥ market
