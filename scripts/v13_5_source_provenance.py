...
AUTHORIZED_EXTENSION_PATHS = frozenset({
    # v13.5.17 owner-functional correction: compact iPhone navigation, concise
    ...
    # v13.5.17 owner spec conformance (2026-08-22): news-risk ⊥ market
