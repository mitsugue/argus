...
AUTHORIZED_EXTENSION_PATHS = frozenset({
    # v13.5.22 owner-functional correction: compact iPhone navigation, concise
    ...
    # v13.5.22 (external-review conformance batch): SHO CORE production
    ...
    # v13.5.22 owner directive: internal engine names removed from every
    ...
    # v13.5.22 owner spec conformance (2026-08-22): news-risk ⊥ market
