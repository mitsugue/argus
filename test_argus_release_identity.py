...
class ReleaseIdentityTests(unittest.TestCase):
    def test_version_sources_are_independent_and_current(self):
        self.assertEqual("13.3.3", identity.backend_version())
        self.assertEqual("13.3.3", identity.frontend_version())
    ...
    def test_four_coordinates_are_never_inferred(self):
        ...
        self.assertEqual({
            "backendVersion": "13.3.3",
            "backendBuildSha": "backend1",
            "frontendVersion": "13.3.3",
    ...
    def test_version_files_are_plain_public_metadata(self):
        ...
        self.assertEqual({"version": "13.3.3"}, backend)
        self.assertEqual("13.3.3", frontend["version"])
