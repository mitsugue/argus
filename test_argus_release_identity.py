...
class ReleaseIdentityTests(unittest.TestCase):
    def test_version_sources_are_independent_and_current(self):
        self.assertEqual("13.2.2", identity.backend_version())
        self.assertEqual("13.2.2", identity.frontend_version())
    ...
    def test_four_coordinates_are_never_inferred(self):
        ...
        self.assertEqual({
            "backendVersion": "13.2.2",
            "backendBuildSha": "backend1",
            "frontendVersion": "13.2.2",
    ...
    def test_public_build_identity_retains_compatibility_fields(self):
        value = durability.build_identity(
            app_version="13.2.2", backend_sha="abc1234",
            frontend_version="13.2.2", frontend_sha="def5678")
        self.assertEqual("13.2.2", value["appVersion"])
        self.assertEqual("13.2.2", value["backendVersion"])
        self.assertEqual("abc1234", value["backendBuildSha"])
        self.assertEqual("13.2.2", value["frontendVersion"])
    ...
    def test_version_files_are_plain_public_metadata(self):
        ...
        self.assertEqual({"version": "13.2.2"}, backend)
        self.assertEqual("13.2.2", frontend["version"])
