...
# ── Quarantine review (v13.5.32, owner directive 2026-08-24) ────────────────
...
# ── Sol escalation routing (v13.5.32, external review 2026-08-25) ───────────
...
def has_extreme_language(subject: str, excerpt: str = "") -> bool:
    """Pure difficulty signal for Sol escalation (v13.5.32)."""
    haystack = _lower(subject) + "\n" + _lower(excerpt)[:2000]
...
def build_news_event(*, message: Mapping[str, Any],
    ...
    return {
        # v13.5.32 NEWS/EVENT DIRECTIONAL IMPACT: an independent axis beside
