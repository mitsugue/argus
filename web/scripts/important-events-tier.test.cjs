#!/usr/bin/env node
'use strict';
// v13.5.36 — important-event constraint tiering (external review item C) and
...
// ── v13.5.36 NEWS/EVENT DIRECTIONAL IMPACT (structural contract) ──────────
...
// v13.5.36: the gate itself lives in domain/newsSignalGate (per-subject
...
// ── v13.5.36 — calendar OUTAGE must not data-gate every symbol ────────────
