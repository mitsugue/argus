#!/usr/bin/env node
'use strict';
// v13.5.35 — important-event constraint tiering (external review item C) and
...
// ── v13.5.35 NEWS/EVENT DIRECTIONAL IMPACT (structural contract) ──────────
...
// v13.5.35: the gate itself lives in domain/newsSignalGate (per-subject
...
// ── v13.5.35 — calendar OUTAGE must not data-gate every symbol ────────────
...
console.log('important-events-tier.test: v13.5.35 outage softening + jargon-free UI ok');
