...
// v13.5.28 (owner): symmetric nav geometry — the same visual pad above and
...
assert.match(acceptance, /hostileNavHeightBeforeRefresh/);
assert.match(acceptance, /hostile-nav-height/);
