...
assert.match(deploy, /needs: \[scope, candidate-identity, business-snapshot-trigger\]/);
assert.match(deploy, /enforce-public-candidate-identity: 'true'/);
assert.match(acceptance, /name: full-release-simulation-1/);
assert.match(acceptance, /name: full-release-simulation-2/);
