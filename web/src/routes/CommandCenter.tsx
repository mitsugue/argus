...
import { MarketIntelligenceChanges } from '../components/chart/ChartIntelligencePanel';
...
export const CommandCenter: React.FC<Props> = ({ onNavigate, onNavigateToAsset }) => {
  ...
  return (
    ...
    >
      ...
      <MarketIntelligenceChanges onOpen={() => {
        try { sessionStorage.setItem('argus.scrollTo', 'chart-intelligence'); } catch { /* ignore */ }
        onNavigate('regime');
      }} />
