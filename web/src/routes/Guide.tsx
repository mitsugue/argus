...
const CAPABILITIES: { area: string; descJa: string }[] = [
  ...
  { area: '予測台帳と自己採点',
    descJa: '毎営業日16:05に「個別銘柄+9資産クラス(SPY/QQQ/GLD/TLT/REIT等)+BTC/ETH+姿勢の判断そのもの」を記録し、翌日に実値と照合して自動採点。個別株の暗記ではなく「局面×資産クラス」の校正を蓄積する設計(姿勢はSPYの実際の動きで採点)。成績はTodayに表示。蓄積した的中率は戦略ラベルの確信度に自動反映される(校正ループ、v10.8+)。' },
  { area: 'AI予想',
