...
const RECENT_UPDATES: [string, string][] = [
  ['v10.27.0', '⚡エントリー診断が米国株に対応 — NVDA/AAPL等の米国株カードにも⚡ボタン。テクニカル(RSI/MACD/ボリンジャー/移動平均クロス/窓)+大口フロー+SPY相対力+決算+地合い+AI見解で診断。日証金/JPX空売りは日本専用のため米国では未取得と正直表示(米国の空売り残はFINRA等で将来対応)'],
