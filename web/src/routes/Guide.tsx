...
const RECENT_UPDATES: [string, string][] = [
  ...
  ['v10.21.0', '🐋 大口の正体推定(Flow Intelligence) — 「この上昇は新規買いか買い戻しか分配か」を、日証金の新規/返済フロー+機関空売り+大口フロー+値動きから確率で推定(新規買い/買い戻し/分配/ノイズ/不明)。断定せず確率・確度・次の確認条件・データの限界を明示。GPT/Geminiの助言を統合'],
