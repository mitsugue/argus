...
const RECENT_UPDATES: [string, string][] = [
  ['v10.15.0', '⚡エントリー診断(entry-scout) — 銘柄の戦略カードから1タップで「入りの瞬間診断」: 60日履歴のトレンド/過熱度(RSI・25日線乖離・続落数)+大口フロー+イベント接近+地合い+曜日を束ねて、攻め好機/押し目検討/中立/見送りを理由つきで即答。日証金・チャート形状など未対応項目は正直に明示(Phase 2)。日本株のみ対応'],
